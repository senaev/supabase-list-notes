...
const PUBLISHABLE_KEY_PLACEHOLDER = 'sb_publishable_XXXXXXXXXXXX-XXXXXXXXXXXXXXXXXX';
    ...
    return <>
        ...
        <form
            onSubmit={(event) => {
                ...
                statusObject.authenticate(nextCredentials).catch((_error) => {
                    showError('Failed to authenticate with provided credentials. Please check them and try again.');
                });
            }}
        ...
        >
            ...
            <section>
                ...
                {statusObject.status === 'wrong-credentials' && <p className={'AuthPage__wrongCredentialsMessage'}>
                    {'Invalid credentials. '}
